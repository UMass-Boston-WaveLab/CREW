...
Figure \ref{sinusoid} shows the number of component sinusoids that make up the MUSIC estimate. This variable is very sensitive to being far more or less than the actual number of sinusoids that make up a signal space. %What can I say about this? Any more than 5 times the number of scatterers and the prediction falls sharply?
