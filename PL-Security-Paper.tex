...
%FIX THIS ALL OF IT The spectral estimation algorithm determines the spatial frequency of each scattering path, those frequencies are inserted into a matrix the size of our sample array. By taking the inverse of that matrix and multiplying it's conjugate by our original sample we arrive at the complex amplitude. %This needs to be clarified a little. Maybe add some math into it. I need to find the paper I took the method from.

%Find somewhere to put a note about threshhold
